...
if __name__ == "__main__":
    ...
    import time
    with open("GD96_b/GD96_b.mtx") as dataset:
        # g = {}
        # graph = Graph()
        ...
        print('--------------------------------------------------')
        s = time.time()
        # list(nx.all_simple_paths(G, source='1', target='1'))
        # list(nx.all_simple_paths(G, source='1', target='2'))
        # list(nx.all_simple_paths(G, source='1', target='3'))
        # list(nx.all_simple_paths(G, source='1', target='4'))
        # print(list(nx.all_simple_paths(G, source='1', target='1')))
        # print(list(nx.all_simple_paths(G, source='1', target='2')))
        # print(list(nx.all_simple_paths(G, source='1', target='3')))
        # print(list(nx.all_simple_paths(G, source='1', target='4')))
        print(nx.shortest_path(G, source='33', target='107'))
        print(time.time() - s)
        ...
        # for path in nx.shortest_path(G, source='100', target='9'):
        #     print(path)
        # print(graph.find_isolated_vertices())
        # print(len(graph.edges()))
        # print(graph.find_all_paths('100', '9'))
        # print(graph.find_all_paths('100', '9'))
        # print(graph.find_all_paths('100', '9'))
        # print(graph.find_all_paths('100', '9'))    
